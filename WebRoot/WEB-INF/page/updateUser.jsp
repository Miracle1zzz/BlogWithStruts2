...
<link rel="stylesheet" type="text/css" href="css/login.css">
  ...
  <body> 
  	...
  	<div class="loginwarrp">
        ...
        <s:iterator value="#request.user" var="person">
			<form action="updatePerson" onkeyup="" onsubmit="return isRight(this);" >
				<li class="login-item">登 录 名:
					<input type="text" name="user_name" class="login_input" value='<s:property value="#person.user_name"/>'/>*
					<span id="msg1"></span>
				</li>
                <li class="login-item">密 码<span>：</span>
					<input type="password" name="user_pwd" class="login_input" value='<s:property value="#person.user_pwd"/>'/>*
				</li>
				<li class="login-item">密码确认<span>：</span>
					<input type="password" name="user_pwd1" class="login_input" value='<s:property value="#person.user_pwd"/>'/>*
				</li>
				...
				<li class="login-item">
					<span>Q Q：</span>
					<input type="text" name="user_qq" class="login_input" value='<s:property value="#person.user_qq"/>'/>
				</li>
				<li class="login-item">
					邮箱地址<span>：</span>
					<input type="text" name="user_email" class="login_input" value='<s:property value="#person.user_email"/>'/>*
				</li>
