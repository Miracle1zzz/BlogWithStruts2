...
<html>
  ...
  <body>
    ...
    <div id="js-modal-holder" class="modal-holder">
      ...
      <form action="loginCheck" id="js-modal" class="modal">
        ...
        <div class="modal__section">
            <div class="input-with-label">
              <input id="name" type="text" class="input-with-label__input" name="user_name">
        ...
        <div class="modal__section">
            <div class="input-with-label">
              <input id="password" type="password" class="input-with-label__input" name="user_pwd">
        ...
        <div class="modal__section">
            <div class="input-with-label">
              <select name="check_select" class="input-with-label__input">
        ...
        <div class="modal__section grid grid--sliced grid--gutter-x2">
          ...
          <div class="grid-bit grid-bit--6-20">
            <button class="button--grey"><a href="register.jsp">注册</a></button>
          </div>
        </div>
      </form>
